...
const ProjectTopicCarousel: React.FC<ProjectTopicCarouselProps> = ({
  ...
  return <div className="w-full max-w-6xl mx-auto">
      ...
      {selectedCareerSentence && !hasGeneratedTopics() && <div className="text-center mb-8">
          <button onClick={handleProjectGenerate} className="bg-black text-white px-8 py-3 rounded-lg hover:bg-gray-800 transition-colors">
            전체 학기 프로젝트 주제 생성
          </button>
        </div>}
